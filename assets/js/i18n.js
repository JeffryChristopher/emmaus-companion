...
var Lang = (function () {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      docGate: 'Period {letter}: {period}',
      gateNotice: 'The Commission has issued no session note for this meeting, and none has been written in its place. What follows is only what the Syllabus itself sets down, the Rite it leads to, and the approved notes that treat the same subjects — with a place to write.',
    ...
    ms: {
      ...
      docGate: 'Tempoh {letter}: {period}',
      gateNotice: 'Suruhanjaya tidak mengeluarkan nota sesi untuk pertemuan ini, dan tiada nota ditulis sebagai gantinya. Yang berikut hanyalah apa yang ditetapkan oleh Silibus itu sendiri, Ritus yang menyusul, dan nota yang diluluskan yang membicarakan perkara yang sama — beserta ruang untuk menulis.',
    ...
    zh: {
      ...
      docGate: '阶段 {letter}：{period}',
      gateNotice: '委员会没有为这次聚会发出课程讲义，本应用程式也没有代为撰写。以下仅为大纲本身所列出的内容、随后举行的礼仪，以及论及同一主题的核准讲义，另附书写的空间。',
    ...
    ta: {
      ...
      docGate: 'காலம் {letter}: {period}',
      gateNotice: 'இந்தச் சந்திப்புக்கு ஆணையம் அமர்வுக் குறிப்பு எதுவும் வெளியிடவில்லை; அதற்குப் பதிலாக எதுவும் எழுதப்படவும் இல்லை. கீழே உள்ளது பாடத்திட்டம் தானே குறிப்பிடுவது, அதைத் தொடர்ந்து வரும் சடங்கு, அதே பொருள்களை விளக்கும் ஒப்புதல் பெற்ற குறிப்புகள் — எழுதுவதற்கான இடத்துடன்.',
